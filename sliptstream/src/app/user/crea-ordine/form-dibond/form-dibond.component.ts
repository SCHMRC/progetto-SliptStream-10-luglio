...
@Component({
  selector: 'app-form-dibond',
  templateUrl: './form-dibond.component.html',
  styleUrls: ['./form-dibond.component.scss']
})
export class FormDibondComponent implements OnInit {
  spessori = spessore;
  forme = forme;
  ...
  constructor(private service: ServiceService, private fireStorage: FireStorageService) {
    this.articolo = this.service.getForm('dibond');

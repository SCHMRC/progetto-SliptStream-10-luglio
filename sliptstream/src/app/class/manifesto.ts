...
export class Manifesto extends Articolo {
  formato: string;
  orientamento: string;
  cerchio?: Cerchio;
  ...
  constructor(idArticolo: string, copie: number, formato: string, orientamento: string, descrizione?: string, allegato?: string, bozze?: string,
    ...
    super(idArticolo, 'Manifesto', copie, descrizione, allegato, bozze, descrizioneModifica, fileModificaURL, numeroModelliBozze, modelloConfermato);
    if (formato === null) { this.formato = '70x100'} else { this.formato = formato; }
